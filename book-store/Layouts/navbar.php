<div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-1">
                <a class=" text-dark text-decoration-none " href="features.html">
                    <h6 class="mx-3"><a class="text-decoration-none text-dark" href="Feature.html"> FEATURES</a></h6>
                </a>
            </div>
            <div class="col-lg-1">
            ...
            <div class="col-lg-1">
                <a class="text-dark d-flex" href="Add to card.html"> <i class="fa fa-shopping-cart mx-3"
                        aria-hidden="true">
